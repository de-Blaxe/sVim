...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    sVimTab.commands = {
      ...
      toggleReader: function() {
        safari.extension.dispatchMessage("toggleReader");
      },

      // Close Safari reader if possible
      closeReader: function() {
        safari.extension.dispatchMessage("closeReader");
      },

      // Show sVimrc page
      showsVimrc: function() {
        safari.extension.dispatchMessage("showsVimrc");
      },

      // Open help page in new tab
      help: function() {
        safari.extension.dispatchMessage("help");
      },
      ...
      previousTab: function() {
        safari.extension.dispatchMessage("previousTab");
      },

      // Go to the first tab
      firstTab: function() {
        safari.extension.dispatchMessage("firstTab");
      },

      // Go to the last tab
      lastTab: function() {
        safari.extension.dispatchMessage("lastTab");
      },

      // Go to the last active tab that's still open
      lastActiveTab: function() {
        safari.extension.dispatchMessage("lastActiveTab");
      },

      // Close the current tab
      quit: function() {
        safari.extension.dispatchMessage("quit");
      },

      // Close the tab to the left of the current tab
      closeTabLeft: function() {
        safari.extension.dispatchMessage("closeTabLeft");
      },

      // Close the tab to the right of the current tab
      closeTabRight: function() {
        safari.extension.dispatchMessage("closeTabRight");
      },

      // Close all tabs to the left of the current tab
      closeTabsToLeft: function() {
        safari.extension.dispatchMessage("closeTabsToLeft");
      },

      // Close all tabs to the right of the current tab
      closeTabsToRight: function() {
        safari.extension.dispatchMessage("closeTabsToRight");
      },

      closeOtherTabs: function() {
        safari.extension.dispatchMessage("closeOtherTabs");
      },

      // Open the last closed tab
      lastClosedTab: function() {
        safari.extension.dispatchMessage("lastClosedTab");
      },

      // Open the last closed tab in background
      lastClosedTabBackground: function() {
        safari.extension.dispatchMessage("lastClosedTabBackground");
      },
      ...
      moveTabLeft: function() {
        safari.extension.dispatchMessage("moveTabLeft");
      },

      // Move current tab right
      moveTabRight: function() {
        safari.extension.dispatchMessage("moveTabRight");
      },
      ...
      // Open new window
      newWindow: function() {
        safari.extension.dispatchMessage("newWindow");
      },

      // Navigate to the next window
      nextWindow: function() {
        safari.extension.dispatchMessage("nextWindow");
      },

      // Navigate to the previous window
      previousWindow: function() {
        safari.extension.dispatchMessage("previousWindow");
      },
    ...
    // Init sVimTab
    safari.extension.dispatchMessage("sendSettings");
    ...
    console.log("message")
      if (event.name == "settings") {
        ...
        console.log(sVimTab.settings.shortcuts);
        sVimTab.bind();
      }
    }, false);
  });
